...
paths = [
"ml_dataset/multi_extrude/qa/results/gemini-2.5-pro-preview-05-06",
"ml_dataset/multi_extrude/qa/results/gpt-4.1-2025-04-14",
"ml_dataset/multi_extrude/qa/results/o3-2025-04-16",
"ml_dataset/multi_extrude/qa/results/claude-3-7-sonnet-20250219",
"ml_dataset/multi_extrude/qa/results/qwen2.5-vl-72b-instruct"

]

def main():
    # model_outputs_path = "ml_dataset/multi_extrude/qa/results/random/model_results.json"
    model_output_path = "ml_dataset/multi_extrude/qa/results/gemini-2.5-pro-preview-05-06"
    qa_dataset = QADataset("ml_dataset/multi_extrude/qa.json")
